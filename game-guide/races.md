...
This race of tall, thin humanoids have just recently (in the last 100 years) developed the technology that allows inter-stellar travel. However, in the last 100 years, their friendly nature has allowed them to trade for much of the technology the other races had achieved.
They do not focus on combat, but they have been preparing themselves in case it arrives. Their ships tend to be geared more towards commerce than combat, and this matches their enterprising nature.
They continue to seek the knowledge of the other races, and to explore to the edges of space. They tend to have relatively good relationships with most of the other races.
...
Humans have the special technology of the jump drive. This allows a ship to jump from one sector to another without having to pass through all the sectors in between. It costs 15**(10?)** turns to use, and for any distances over 15**(10?)** sectors away there is a possibility of a misjump of up to 8 sectors.
...
Because of their small stature, the Salvene have developed the technology of Illusion Generators. These generators allow them to mask the appearance of their ships. They can pose as a helpless escape pod, a massive warbird, or anything in between. However, they are not foolproof. A decent scanner is able to see through the illusion.

### Special Abilities

The Salvene race thrives on deception. All of their ships that cost credits can support an illusion generator. This forces players to carefully consider the true strength of a Salvene opponent before beginning a fight.
...
### Special Abilities
**(THIS WAS LEFT BLANK ON OLD WIKI)**
